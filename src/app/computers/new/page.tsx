    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#1C1E21]">Add Computer</h1>
            <p className="text-sm text-[#65676B]">เพิ่ม Computer ใหม่เข้าระบบ</p>
          </div>
        </div>

        {error && (
          <div className="p-4 bg-[#FDEDEF] border border-red-200 rounded-lg text-sm text-[#FA3E3E]">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Hardware Info */}
          <div className="bg-white rounded-xl border border-[#DADDE1] p-6">
            <h3 className="text-lg font-semibold text-[#1C1E21] mb-4">Hardware</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Network */}
          <div className="bg-white rounded-xl border border-[#DADDE1] p-6">
            <h3 className="text-lg font-semibold text-[#1C1E21] mb-4">Network</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Location & Assignment */}
          <div className="bg-white rounded-xl border border-[#DADDE1] p-6">
            <h3 className="text-lg font-semibold text-[#1C1E21] mb-4">Location & Assignment</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Purchase Info */}
          <div className="bg-white rounded-xl border border-[#DADDE1] p-6">
            <h3 className="text-lg font-semibold text-[#1C1E21] mb-4">Purchase Info</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Remark */}
          <div className="bg-white rounded-xl border border-[#DADDE1] p-6">
            <h3 className="text-lg font-semibold text-[#1C1E21] mb-4">Remark</h3>
            <textarea
              name="remark"
              value={form.remark}
              onChange={handleChange}
          ...
          <div className="flex justify-end gap-3">
            <Link
              href="/computers"
              className="px-6 py-2.5 text-sm border border-[#DADDE1] rounded-lg hover:bg-[#F0F2F5]"
            >
              ยกเลิก
            </Link>
            <button
